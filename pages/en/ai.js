  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white relative overflow-hidden">
      <Head>
        ...
        <meta name="description" content="Learn more about artificial intelligence, machine learning, and data analysis on Datalorian AI." />
        <meta property="og:title" content="AI, ML & Data | Datalorian AI" />
        <meta property="og:description" content="Learn more about artificial intelligence, machine learning, and data analysis on Datalorian AI." />
              ...
              <div className="lang-selector">
                ...
                {showDropdown && (
                  <div className="lang-dropdown">
                    <a href="/pl/ai" className="lang-option">PL</a>
                  </div>
                )}
              </div>
            </div>
      ...
      <section className="hero-section">
        <div className="hero-content animate-fade-in-up">
          ...
          <p className="hero-subtitle animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            Discover the world of artificial intelligence, machine learning, and data analysis 
        ...
        <div className="space-y-8">
          ...
          <div className="card animate-fade-in-up" style={{animationDelay: '0.4s'}}>
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              AI-powered recommendation systems can dynamically analyze user behaviors, product data, 
              and real-time context. Thanks to machine learning models, hyper-personalization is possible, 
              which significantly increases conversion rates in e-commerce.
            </p>
          </div>
          ...
          <div className="card animate-fade-in-up" style={{animationDelay: '0.6s'}}>
            ...
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
              Artificial Intelligence (AI) is a branch of computer science that deals with creating systems 
              capable of performing tasks that require human intelligence, such as understanding language, 
              recognizing images, or making decisions.
            </p>
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
              AI finds applications in many industries: from medicine, through finance, to entertainment. 
              Examples include speech recognition systems, autonomous vehicles, machine translators, 
              or personalized recommendations in e-commerce.
            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
              Modern AI is based on large datasets and advanced algorithms that allow machines to learn 
              from experience and predict future events.
            </p>
          </div>
          ...
          <div className="card animate-fade-in-up" style={{animationDelay: '0.8s'}}>
            ...
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
              Machine Learning (ML) is a subfield of AI that involves building models that learn from data. 
              ML algorithms can detect patterns and predict future events without hard-coding rules.
            </p>
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
              ML is used, among others, for medical image analysis, fraud detection in banking, 
              demand forecasting, or automatic photo tagging in social media.
            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
          ...
          <div className="card animate-fade-in-up" style={{animationDelay: '1.0s'}}>
            ...
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
              ...
              whose goal is to extract value from data. Data is the fuel for AI and ML – the better the data, 
              the better the models.
            </p>
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
              The Data Science process includes collecting, cleaning, analyzing, and visualizing data, 
              as well as implementing predictive models in business practice.
            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
              In the Big Data era, the importance of tools for processing huge volumes of information is growing, 
              such as Hadoop, Spark, or cloud computing.
            </p>
          </div>
