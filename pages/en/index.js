  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white relative overflow-hidden">
      <Head>
        ...
        <meta name="description" content="Datalorian AI is a website with educational and informational content about artificial intelligence, machine learning, and data analysis." />
        <meta property="og:title" content="Datalorian AI" />
        <meta property="og:description" content="Datalorian AI is a website with educational and informational content about artificial intelligence, machine learning, and data analysis." />
              ...
              <div className="lang-selector">
                ...
                {showDropdown && (
                  <div className="lang-dropdown">
                    <a href="/pl" className="lang-option">PL</a>
                  </div>
                )}
              </div>
            </div>
      ...
      <section className="hero-section">
        <div className="hero-content animate-fade-in-up">
          ...
          <p className="hero-subtitle animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            Discover the world of modern technologies, explore practical applications of AI and ML, 
            and get inspired by examples from various industries.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-16 relative z-10">
        <div className="card animate-fade-in-up" style={{animationDelay: '0.6s'}}>
          <div className="text-center">
            ...
            <p className="text-violet-400 font-semibold text-lg animate-pulse-slow">
