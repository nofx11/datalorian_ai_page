  ...
  return (
    <div className="min-h-screen bg-[#0a0a23] text-white font-sans relative overflow-hidden">
      <Head>
        ...
        <meta name="description" content="Datalorian AI is an informational and educational website about artificial intelligence, machine learning, and data science." />
        <meta property="og:title" content="Datalorian AI" />
        <meta property="og:description" content="Datalorian AI is an informational and educational website about artificial intelligence, machine learning, and data science." />
      ...
      {/* Planets SVG with orbital animation - enhanced version */}
      <svg className="absolute top-0 left-0 w-full h-full z-0 pointer-events-none" style={{opacity:0.8}} viewBox="0 0 1440 900" fill="none" xmlns="http://www.w3.org/2000/svg">
        {/* Planet 1 (blue) - perfect circle, 3D effect, clouds and atmosphere */}
        <g>
          {/* Main planet as a circle with spherical gradient */}
          ...
          {/* Irregular clouds as path, fitted to the circle */}
        ...
        {/* Planet 2 with ring and atmosphere */}
        <g>
          {/* Ring - more subtle */}
          <ellipse cx="1200" cy="470" rx="90" ry="18" fill="url(#ring2)" opacity="0.18" />
          {/* Main planet as a circle with spherical gradient */}
          <circle cx="1200" cy="470" r="60" fill="url(#planet2grad)" filter="url(#shadow2)" />
          {/* Atmosphere - circular, subtle */}
          <circle cx="1200" cy="470" r="72" fill="url(#atmos2)" opacity="0.13" />
          {/* Shadow on the left */}
          <ellipse cx="1165" cy="470" rx="28" ry="55" fill="url(#planet2shadow)" opacity="0.18" />
          {/* Irregular clouds/spots */}
          <path d="M1170 470 Q1185 450 1200 460 Q1225 470 1210 490 Q1195 495 1180 480 Z" fill="#fffbe6" opacity="0.13" />
          <path d="M1210 440 Q1220 435 1240 460 Q1230 470 1215 460 Z" fill="#fde68a" opacity="0.18" />
          <path d="M1190 490 Q1205 505 1220 495 Q1215 490 1200 492 Z" fill="#fbbf24" opacity="0.14" />
        </g>
        <defs>
      ...
      {/* Sticky top bar with logo, navigation and language dropdown */}
      ...
      <div className="max-w-2xl mx-auto mt-8 mb-6 text-center">
        <p className="text-lg text-gray-100">
          Datalorian AI is an informational and educational website about artificial intelligence (AI), machine learning (ML), and data science.
        </p>
        <p className="mt-2 text-gray-300">
          Discover the world of modern technologies, explore practical applications of AI and ML, and get inspired by examples from various industries. Our goal is to share knowledge in an accessible way – for both beginners and advanced users.
        </p>
        <p className="mt-2 text-blue-400 font-semibold">More content coming soon!</p>
      </div>
      <main className="max-w-4xl mx-auto p-4 relative z-10">
        <div className="my-6 flex flex-col sm:flex-row gap-4 items-center">
          <a href="/en/chat" className="px-6 py-2 rounded-full bg-gradient-to-r from-blue-900 to-blue-400 text-white font-bold shadow-lg hover:from-blue-600 hover:to-blue-200 transition-colors duration-200 text-lg">Let's chat</a>
          <a href="/en/ai" className="px-6 py-2 rounded-full bg-gradient-to-r from-blue-900 to-blue-400 text-white font-bold shadow-lg hover:from-blue-600 hover:to-blue-200 transition-colors duration-200 text-lg">Learn more</a>
        </div>
      </main>
