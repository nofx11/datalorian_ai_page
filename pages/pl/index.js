              ...
              <div className="lang-selector">
                ...
                {showDropdown && (
                  <div className="lang-dropdown">
                    <a href="/en" className="lang-option">EN</a>
                  </div>
                )}
              </div>
            </div>
      ...
      <section className="hero-section">
        <div className="hero-content animate-fade-in-up">
          ...
          <p className="hero-subtitle animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            Odkrywaj świat nowoczesnych technologii, poznawaj praktyczne zastosowania AI i ML, 
            inspiruj się przykładami z różnych branż.
          </p>
        ...
        <div className="card animate-fade-in-up" style={{animationDelay: '0.6s'}}>
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Naszym celem jest dzielenie się wiedzą w przystępny sposób – zarówno dla początkujących, 
              jak i zaawansowanych.
            </p>
            <p className="text-violet-400 font-semibold text-lg animate-pulse-slow">
              Więcej treści już wkrótce!
            </p>
          </div>
        </div>
      </section>
