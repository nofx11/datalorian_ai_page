  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white relative overflow-x-hidden pt-16">
      <Head>
        ...
        <meta
          name="description"
          content="Datalorian AI to strona z treściami edukacyjnymi i informacyjnymi o sztucznej inteligencji, uczeniu maszynowym i analizie danych."
        />
              ...
              <div className="lang-selector">
                ...
                {showDropdown && (
                  <div className="lang-dropdown">
                    <a href="/en" className="lang-option">
                      EN
                    </a>
                  </div>
                )}
