  ...
  return (
    <div className="min-h-screen bg-[#0a0a23] text-white font-sans flex flex-col items-center justify-center p-6 relative">
      ...
      <div className="absolute top-4 right-4 space-x-4">
        <a href="/en/chat" className="lang-btn">EN</a>
      </div>
      <h1 className="text-3xl md:text-5xl font-bold text-center mb-6 drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)]" style={{fontFamily: 'Orbitron, Arial, sans-serif'}}>Rozmowa z założycielem Datalorian AI</h1>
