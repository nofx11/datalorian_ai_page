          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block">
              <div className="flex items-baseline space-x-4">
                <a href="/pl/chat" className="nav-link">Porozmawiajmy</a>
                <a href="/pl/ai" className="nav-link">Dowiedz się więcej</a>
              </div>
            </div>
              ...
              <div className="lang-selector">
                ...
                {showDropdown && (
                  <div className="lang-dropdown">
                    <a href="/en/ai" className="lang-option">EN</a>
                  </div>
                )}
              </div>
            </div>
      ...
      <section className="hero-section">
        <div className="hero-content animate-fade-in-up">
          ...
          <p className="hero-subtitle animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            Odkryj świat sztucznej inteligencji, uczenia maszynowego i analizy danych 
            w przystępny i praktyczny sposób.
          </p>
        </div>
      </section>
        ...
        <div className="space-y-8">
          ...
          <div className="card animate-fade-in-up" style={{animationDelay: '0.4s'}}>
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              ...
              dane o produktach oraz kontekst w czasie rzeczywistym. Dzięki modelom uczenia maszynowego możliwa jest 
              hiperpersonalizacja, co znacząco zwiększa współczynniki konwersji w e-commerce.
            </p>
          </div>
          ...
          <div className="card animate-fade-in-up" style={{animationDelay: '0.6s'}}>
            ...
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
              Sztuczna inteligencja (AI) to dziedzina informatyki zajmująca się tworzeniem systemów zdolnych do wykonywania 
              zadań wymagających inteligencji ludzkiej, takich jak rozumienie języka, rozpoznawanie obrazów czy podejmowanie decyzji.
            </p>
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
              AI znajduje zastosowanie w wielu branżach: od medycyny, przez finanse, po rozrywkę. Przykłady to systemy 
              rozpoznawania mowy, autonomiczne pojazdy, tłumacze maszynowe czy personalizowane rekomendacje w e-commerce.
            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
              Współczesne AI opiera się na dużych zbiorach danych i zaawansowanych algorytmach, które pozwalają maszynom 
              uczyć się na podstawie doświadczenia i przewidywać przyszłe zdarzenia.
            </p>
          </div>
          ...
          <div className="card animate-fade-in-up" style={{animationDelay: '0.8s'}}>
            ...
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
              Uczenie maszynowe (ML) to poddziedzina AI, która polega na budowaniu modeli uczących się na podstawie danych. 
              Algorytmy ML potrafią wykrywać wzorce i przewidywać przyszłe zdarzenia bez programowania reguł na sztywno.
            </p>
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
              ML jest wykorzystywane m.in. do analizy obrazów medycznych, detekcji oszustw w bankowości, prognozowania popytu 
              czy automatycznego tagowania zdjęć w mediach społecznościowych.
            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
              Najpopularniejsze techniki ML to uczenie nadzorowane, nienadzorowane oraz uczenie przez wzmacnianie. 
              Każda z nich znajduje zastosowanie w innych typach problemów.
            </p>
          </div>
          ...
          <div className="card animate-fade-in-up" style={{animationDelay: '1.0s'}}>
            ...
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
              ...
              której celem jest wydobywanie wartości z danych. Dane są paliwem dla AI i ML – im lepsze dane, tym lepsze modele.
            </p>
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
              Proces Data Science obejmuje zbieranie, czyszczenie, analizę i wizualizację danych, a także wdrażanie 
              modeli predykcyjnych w praktyce biznesowej.
            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
              W erze Big Data rośnie znaczenie narzędzi do przetwarzania ogromnych wolumenów informacji, 
              takich jak Hadoop, Spark czy chmura obliczeniowa.
            </p>
          </div>
